...
const searchArtists = (token, name) => {
  return fetch(
...
const searchArtistAlbums = (token, artistID) => {
  return fetch(
    `https://api.spotify.com/v1/artists/${artistID}/albums?limit=50&offset=0`,
    {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json; charset=utf-8',
...
export { LOGIN_URI, searchArtists, searchArtistAlbums };
